...
(defun print-agg ()
  ...
  ;;       do)
  (let* ((elem (aref (cl-mpm/aggregate::sim-agg-elems *sim*) 1))
         (map-size 4)
    ...
    (let ((E (cl-mpm/aggregate::agg-shape-functions elem))
      ...
      (pprint id)
      ;; (pprint (cl-mpm/aggregate::agg-contribution-list elem))

      ;; (pprint (magicl:@ (magicl:transpose E) (cl-mpm/utils::arb-matrix-from-list (list 1d0 1d0 
      ;;                                                                                  0d0 0d0
      ;;                                                                                  0d0 0d0
      ;;                                                                                  0d0 0d0
      ;;                                                                                  0d0 0d0
      ;;                                                                                  ) (* 2 5) 1)))
      ;; (pprint proj)
      ;; (pprint (magicl:transpose E))
      ;; (pprint )
      ;; (pprint f)
      ;; (pprint (magicl:@ expander proj f))
      ;; (pprint (magicl:@ (magicl:transpose E) f))
      ;; (pprint (magicl:@ (magicl:transpose E) f))
      ;; (pprint (magicl:@ proj E (magicl:transpose E) f))
      ;; (pprint (magicl:@ (cl-mpm/aggregate::compute-internal-expander *sim* elem) (magicl:transpose E) f))
      ;; (cl-mpm/aggregate::project-vector
      ;;  *sim*
      ;;  elem
      ;;  cl-mpm/mesh::node-force
      ;;  (magicl:@ expander (magicl:transpose E) f)
      ;;  )
      ;; (setf f (cl-mpm/aggregate::assemble-vector *sim* elem #'cl-mpm/mesh::node-force))
      ;; (pprint (magicl:@ proj f))

      ;; (pprint (magicl:@ proj f))
      ;; (pprint (magicl:@ E f))
      ;; (pprint (magicl:@ E (magicl:transpose E)))
      ;; (pprint (magicl:@ (magicl:transpose E) f))
      ;; (pprint (magicl:@ E (magicl:transpose E) f))
      ;; (pprint (magicl:@ id (magicl:@ proj f)))
      ;; (pprint (magicl:@ E (magicl:@ (magicl:inv m) (magicl:transpose E) f)))
      ;; (pprint (magicl:@ (magicl:inv mii) f))
      ;; (pprint (magicl:@ E (magicl:transpose E) f))
      ;; (pprint (magicl:@ (magicl:transpose E) f))
      ;; (pprint (magicl:@ E proj f))
      ;; (format t "Full mat:~%")
      ;; (pprint mii)
      ;; (format t "~%")
      (format t "Mass mat:~%")
      ...
      (format t "~%")
      ;; (pprint m)
      ;; (pprint (magicl:@ E (magicl:transpose E) v))
      ;; (pprint v)
      ;; (pprint
      ;;  (magicl:@
      ;;   E
      ;;   (magicl:linear-solve
      ;;    m
      ;;    (magicl:@ (magicl:transpose E) (magicl:@ mii v)))))

      ;; (let ((temp
      ;;         (magicl:@
      ;;          E
      ;;          (magicl:inv m)
      ;;          (magicl:@ (magicl:transpose E) (magicl:@ mii)))
      ;;         ))
      ;;   (pprint 
      ;;    (magicl:@ (cl-mpm/aggregate::agg-vel-projection-matrix elem) v))
      ;;   (pprint
      ;;    (magicl:@ temp v)
      ;;    ))
      ;; (pprint
      ;;  (magicl:@
      ;;   (cl-mpm/aggregate::agg-vel-projection-matrix elem)
      ;;   v
      ;; ;;   ))
      ;; (pprint v)
      )
