...
(defmethod initialize-instance :after ((sim cl-mpm/damage::mpm-sim-damage) &key)
...
;;                                            0d0))
;;         (cl-mpm/output::save-parameter "damage-dyk"
...
;;                                             (cl-mpm/particle::mp-local-length mp)) 1))
...
;;         ;;                (cl-mpm/particle::mp-damage-pressure mp))))
;;         ;;       ;; (cl-mpm/particle::mp-c mp)
;;         ;;       )
;;         ;;      0d0)
;;         ;;  )
