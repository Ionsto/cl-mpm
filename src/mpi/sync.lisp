                                          ...
                                          (when (> (length object) 0)
                                            (cl-mpm/utils::bpdotimes
                                             ...
                                             (let ((mp (aref object i)))
                                               (setf
                                                ;; (cl-mpm/particle::mp-cached-nodes mp)
                                               ...
                                               ;; (setf (fill-pointer (cl-mpm/particle::mp-cached-nodes mp)) 0)
                                               (when (typep mp 'cl-mpm/particle::particle-damage);; (slot-exists-p mp 'cl-mpm/particle::mp-local-list)
...
(defmethod cl-store::serializable-slots ((object cl-mpm/particle::particle))
