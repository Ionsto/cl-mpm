...
(defclass particle-elastic-damage-tcs (particle-elastic-damage)
...
(defclass particle-damage-frictional (particle-elastic-damage-tcs)
  ((friction-angle
    :accessor mp-friction-angle
    :initarg :friction-angle
    :initform 30d0)
   (model
    :accessor mp-friction-model
    ...
    (with-accessors ((stress cl-mpm/particle:mp-stress)
      ...
      (when t;(<= damage 1d0)
        ...
        (let ((new-damage
                (max
                 damage-n
                 (cl-mpm/damage::damage-response-exponential-peerlings-residual k E init-stress ductility residual-strength))))
    ...
    (with-accessors ((damage cl-mpm/particle:mp-damage)
      ...
      (setf k
            (max
             ...
             ybar))
      (cl-mpm/damage::compute-damage mp)
      (setf damage-inc (min 1d0 (- damage damage-n)))
      (values))))
...
(defmethod cl-mpm/damage::compute-damage ((mp cl-mpm/particle::particle-elastic-damage-tcs))
  (with-accessors ((k cl-mpm/particle::mp-history-stress)
                   (k-n cl-mpm/particle::mp-history-stress-n)
                   (E cl-mpm/particle::mp-e)
                   (damage cl-mpm/particle:mp-damage)
   ...
   (let ()
     (setf damage (cl-mpm/damage::damage-response-exponential-peerlings-residual k E init-stress ductility
                                                                                 residual-strength))
     (setf
